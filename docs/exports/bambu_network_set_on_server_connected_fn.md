...
**Group:** callback registration (server_connected)
**RVA:** `0x1bc1a0` &nbsp; **VA:** `0x1801bc1a0`
...
int bambu_network_set_on_server_connected_fn(agent_t *agent, cb_t *fn);
```
...
Fires when the cloud MQTT broker connection comes up after bambu_network_connect_server.

...
**Group:** callback registration (local_message)
**RVA:** `0x1bbfc0` &nbsp; **VA:** `0x1801bbfc0`
...
int bambu_network_set_on_local_message_fn(agent_t *agent, cb_t *fn);
```
...
Delivers each MQTT-style message received over a LAN-mode session.
